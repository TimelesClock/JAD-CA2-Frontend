<body>
	...
	<div class="flex flex-row items-center">
		<svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 mx-2 stroke-slate-800 fill-none"
		...
		<div class="dropdown dropdown-end">
			<label tabindex="0" class="btn btn-ghost rounded-btn p-0"> 
				<svg
					xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 mx-2 stroke-slate-800 fill-none"
					viewBox="0 0 24 24" stroke-width="1.5">
						  <path stroke-linecap="round" stroke-linejoin="round"
